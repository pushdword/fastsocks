...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/protohandler: ${OBJECTFILES}
	...
	${LINK.c} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/protohandler ${OBJECTFILES} ${LDLIBSOPTIONS}

${OBJECTDIR}/auth_struct.pb-c.o: auth_struct.pb-c.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/auth_struct.pb-c.o auth_struct.pb-c.c

${OBJECTDIR}/fastsocks.o: fastsocks.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/fastsocks.o fastsocks.c
